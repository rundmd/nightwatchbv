define([
  ...
  return { 
    ...
    groups: {
      group1Filter: { locator: elems.GROUP_FILTER_LOCATOR, text: 'brand-partners', locatorType: 'id', clearLocator: elems.GROUP_FILTER_LOCATOR, clearLocatorType: 'css', results: props.GROUP1_FILTER_RESULTS },
      group2Filter: { locator: elems.GROUP_FILTER_LOCATOR, text: 'rights-management', locatorType: 'id', clearLocator: elems.GROUP_FILTER_LOCATOR, clearLocatorType: 'css', results: props.GROUP2_FILTER_RESULTS },
      group3Filter: { locator: elems.GROUP_FILTER_LOCATOR, text: 'jcp-content', locatorType: 'id', clearLocator: elems.GROUP_FILTER_LOCATOR, clearLocatorType: 'css', results: props.GROUP3_FILTER_RESULTS },
    },
  };
